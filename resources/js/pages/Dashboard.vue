            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p class="text-xs text-muted-foreground">
                            {{ formatCurrency(metrics.month_revenue) }} this
                            month
                        </p>
                    </CardContent>
                </Card>
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription
                            >Latest member registrations</CardDescription
                        >
                    </CardHeader>
                    <CardContent>
                        ...
                        >
                            <Users class="mx-auto mb-2 h-12 w-12 opacity-20" />
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="space-y-4">
                            <div
                                v-for="(amount, index) in charts.revenue_by_day
                                    .data"
                                :key="index"
                                class="flex items-center justify-between"
                            >
                                <span class="text-sm text-muted-foreground">
                                    {{
                                        new Date(
                                            charts.revenue_by_day.labels[index],
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        <div
                                            ...
                                            :style="{
                                                width: `${(amount / Math.max(...charts.revenue_by_day.data)) * 100}%`,
                                            }"
                                        />
                                    </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="space-y-4">
                            <div
                                v-for="(count, index) in charts.check_ins_by_day
                                    .data"
                                :key="index"
                                class="flex items-center justify-between"
                            >
                                <span class="text-sm text-muted-foreground">
                                    {{
                                        new Date(
                                            charts.check_ins_by_day.labels[
                                                index
                                            ],
                                        ).toLocaleDateString('en-US', {
                                            weekday: 'short',
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        <div
                                            ...
                                            :style="{
                                                width: `${(count / Math.max(...charts.check_ins_by_day.data)) * 100}%`,
                                            }"
                                        />
                                    </div>
                        ...
                        >
                            ...
                            >
                                <div class="rounded-lg bg-orange-500/10 p-2">
                                    <FileText
                                        class="h-4 w-4 text-orange-600 dark:text-orange-500"
                                    />
                                </div>
                                <div class="text-left">
