...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-primary/10 to-accent/10 p-4"
    >
        <div class="w-full max-w-md">
            ...
            <Card>
                ...
                <CardContent>
                    <div
                        v-if="status"
                        class="mb-6 rounded-lg bg-green-50 p-3 text-center text-sm font-medium text-green-600 dark:bg-green-900/20"
                    >
                        {{ status }}
                    </div>
                        ...
                        <div class="grid gap-2">
                            ...
                            <div class="relative">
                                ...
                                <Input
                                    ...
                                    inputmode="numeric"
                                    placeholder="****"
                                    class="pl-10 text-center text-2xl tracking-widest"
                                />
                            </div>
                            <InputError :message="errors.pin" />
                            <p class="text-xs text-muted-foreground">
                                Your 4-digit PIN was provided when you
                                registered
                            </p>
                        </div>
                    ...
                    <div
                        class="mt-6 border-t pt-4 text-center text-sm text-muted-foreground"
                    >
