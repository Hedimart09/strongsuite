...
import { XCircle, Home, Mail, RefreshCcw } from 'lucide-vue-next';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-gray-900 dark:to-gray-800">
        <div class="container mx-auto flex min-h-screen items-center justify-center px-4 py-16">
            <div class="w-full max-w-2xl">
                <!-- Error Icon -->
                <div class="mb-8 text-center">
                    <div class="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-red-100 dark:bg-red-900">
                ...
                <div class="rounded-xl bg-white p-8 shadow-lg dark:bg-gray-800">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 dark:text-blue-300">
                                    If you continue to experience issues, please contact our support team. They'll be happy to assist you.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row">
                        <button
                            @click="$inertia.visit(window.history.state?.back || '/member/login')"
                ...
                <p class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
                    Your account has not been charged. You can safely try the payment again.
                </p>
            </div>
        </div>
    </div>
