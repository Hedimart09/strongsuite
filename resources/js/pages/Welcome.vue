...
<template>
    ...
    <div class="min-h-screen bg-black">
                ...
                <div class="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
                    ...
                    <div class="flex flex-col justify-center">
                        <h1 class="text-5xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">
                            Transform Your
                            <span class="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                                Fitness Journey
                            </span>
                        </h1>
                        ...
                        <div class="mt-10 flex items-center gap-4">
                            <Link
                                v-if="!$page.props.auth.user"
                                :href="register()"
                                class="rounded-lg bg-primary px-8 py-4 text-base font-semibold text-primary-foreground transition hover:bg-primary/90 shadow-lg shadow-primary/50"
                            >
                                Join Now
                            </Link>
                            <a
                                href="#features"
                                class="rounded-lg border-2 border-white/30 px-8 py-4 text-base font-semibold text-white backdrop-blur-sm transition hover:bg-white/10 hover:border-white/50"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="group rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5 p-8 backdrop-blur-sm transition hover:border-primary/50 hover:from-primary/20 hover:to-primary/10">
                            <div class="text-4xl font-bold text-primary">500+</div>
                            <div class="mt-2 text-sm font-medium text-white/90">Active Members</div>
                        </div>
                        <div class="group rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5 p-8 backdrop-blur-sm transition hover:border-primary/50 hover:from-primary/20 hover:to-primary/10">
                            <div class="text-4xl font-bold text-primary">50+</div>
                            <div class="mt-2 text-sm font-medium text-white/90">Expert Trainers</div>
                        </div>
                        <div class="group rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5 p-8 backdrop-blur-sm transition hover:border-primary/50 hover:from-primary/20 hover:to-primary/10">
                            <div class="text-4xl font-bold text-primary">24/7</div>
                            <div class="mt-2 text-sm font-medium text-white/90">Access Available</div>
                        </div>
                        <div class="group rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5 p-8 backdrop-blur-sm transition hover:border-primary/50 hover:from-primary/20 hover:to-primary/10">
                            <div class="text-4xl font-bold text-primary">5★</div>
                            <div class="mt-2 text-sm font-medium text-white/90">Member Ratings</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Features Section -->
        <section id="features" class="bg-gray-950 py-20">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    <!-- Feature 1 -->
                    <div class="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition hover:bg-white/10">
                        ...
                        <p class="mt-2 text-gray-400">
                            Effortlessly manage member profiles, subscriptions, and attendance with QR code check-ins.
                        </p>
                    </div>
                    ...
                    <div class="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition hover:bg-white/10">
                        ...
                        <p class="mt-2 text-gray-400">
                            Accept payments via Stripe, Paystack, Flutterwave, and mobile money. Multi-currency support included.
                        </p>
                    </div>
                    ...
                    <div class="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition hover:bg-white/10">
                        ...
                        <p class="mt-2 text-gray-400">
                            Schedule classes, manage bookings, and handle waitlists with an intuitive booking system.
                        </p>
                    </div>
                    ...
                    <div class="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition hover:bg-white/10">
                        ...
                        <p class="mt-2 text-gray-400">
                            Track member growth, revenue, attendance trends, and gain insights to grow your business.
                        </p>
                    </div>
                    ...
                    <div class="group rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition hover:bg-white/10">
                        ...
                        <p class="mt-2 text-gray-400">
                            Multi-currency, multi-language, and timezone support. Built for Ghana and the world.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="relative overflow-hidden py-24">
            ...
            <div class="absolute inset-0 z-0">
                <img
                    ...
                    class="h-full w-full object-cover"
                />
                <div class="absolute inset-0 bg-gradient-to-br from-black/90 via-black/80 to-primary/60"></div>
            </div>
                ...
                <div class="text-center">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                        <Link
                            v-if="!$page.props.auth.user"
                            :href="register()"
                            class="rounded-lg bg-primary px-8 py-4 text-base font-semibold text-primary-foreground transition hover:bg-primary/90 shadow-xl shadow-primary/30"
                        >
                            Join Now
                        </Link>
                        <Link
                ...
                <div class="grid gap-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-2">
                            <li>
                                <a href="#features" class="text-sm text-gray-400 hover:text-white transition">
                                    Features
                                </a>
                            </li>
                            <li>
                            ...
                            <li v-if="canRegister">
                                <Link :href="register()" class="text-sm text-gray-400 hover:text-white transition">
                                    Register
                                </Link>
                            </li>
                        </ul>
