    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Register New Member</h1>
                    <p class="text-sm text-muted-foreground mt-1">Add a new member to the gym</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div v-if="photoPreview" class="mt-2">
                                <img :src="photoPreview" alt="Photo preview" class="h-20 w-20 rounded-lg object-cover" />
                            </div>
                        </div>
                ...
                <div class="rounded-xl border border-sidebar-border/70 dark:border-sidebar-border p-6">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            <label for="emergency_contact_name" class="block text-sm font-medium mb-2">Contact Name *</label>
                            <input
                        ...
                        <div>
                            <label for="emergency_contact_phone" class="block text-sm font-medium mb-2">Contact Phone *</label>
                            <input
                ...
                <div class="flex gap-4 justify-end">
                    <a
                        href="/members"
                        class="inline-flex items-center justify-center rounded-lg border border-input bg-background px-4 py-2 text-sm font-medium ring-offset-background transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    >
                        Cancel
                    </a>
                    <button
                    ...
                    >
                        {{ form.processing ? 'Registering...' : 'Register Member' }}
                    </button>
                </div>
            </form>
        </div>
