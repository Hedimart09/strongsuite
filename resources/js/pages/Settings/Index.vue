...
import { Building2, CreditCard, Globe, Percent, Upload } from 'lucide-vue-next';
import { ref } from 'vue';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                >
                    <div
                        class="border-b border-sidebar-border/50 bg-sidebar/30 px-6 py-4"
                    >
                    ...
                    <div class="space-y-4 p-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    v-if="logoPreview"
                                    class="h-24 w-24 overflow-hidden rounded-lg border-2 border-dashed border-input"
                                >
                                    <img
                                        :src="logoPreview"
                                        alt="Logo preview"
                                ...
                                <div
                                    v-else
                                    class="flex h-24 w-24 items-center justify-center rounded-lg border-2 border-dashed border-input bg-sidebar/30"
                                >
                                    <Upload
                                ...
                                <div class="flex-1">
                                    <input
                                        ...
                                        accept="image/*"
                                        class="block w-full text-sm text-muted-foreground file:mr-4 file:rounded-lg file:border file:border-input file:bg-background file:px-4 file:py-2 file:text-sm file:font-medium hover:file:bg-sidebar/50"
                                    />
                                    <p
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <div
                                ...
                                :key="gateway.id"
                                class="flex items-start gap-3 rounded-lg border border-sidebar-border/50 p-4"
                            ...
                            >
                                <input
                                    ...
                                    :checked="
                                        form.payment_gateways?.includes(
                                            gateway.id,
                                        )
                                    "
                        ...
                        <p
                            v-if="form.errors.payment_gateways"
                ...
                <div class="flex justify-end gap-4">
                    <button
                        ...
                        class="rounded-lg bg-primary px-6 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
                    >
